...
| **Rework `scripts/watch-release-iteration.sh`** | Instructed not to unless it misreports. It did not: run for real this round it reported `10` on v1.3.0.24 with CI green, then `idle` naming this branch once it was pushed |
